...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 w-auto flex justify-between items-center py-4 header-glass-background ${scrolled && 'border-b-[1px] border-zinc-300'}`}>
      <div className="gap-6 w-full flex items-center justify-between">
        <div>
          <Link href="/" className="w-max gap-2 flex items-center justify-center py-2 group transition-all hover:px-4 hover:bg-zinc-900 hover:rounded">
