    ...
    <div className='w-[500px] overflow-hidden'>
      <div className='gap-6 flex flex-col p-8'>
        <div className="w-full text-start">
          <h2 className='text-xl font-bold text-zinc-800'>Giris yap</h2>
        </div>
        <form className='w-full space-y-6'>
          ...
          <div className="gap-4 flex items-center justify-between">
            <label htmlFor="remember-me" className="gap-2 w-max flex items-center cursor-pointer">
              ...
              <label htmlFor="remember-me" className="text-xs sm:text-sm text-zinc-700 cursor-pointer">Oturumu acik tut</label>
            </label>
            <Link href='/auth/forgot-password' className='w-max border-b-2 border-zinc-400 hover:border-zinc-700 transition-all'>
              <span className='text-xs sm:text-sm text-zinc-800 font-medium mt-[3px]'>Sifreni mi unuttun?</span>
            </Link>
          </div>
          <button
            type='submit'
        ...
        <div className='w-full text-center'>
          <Link href='/auth/register'>
            <span className='text-sm text-zinc-600 font-medium underline'>Hesabin yok mu, olusturmak icin tikla!</span>
          </Link>
        </div>
      </div>
    </div>
